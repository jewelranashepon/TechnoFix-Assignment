...
const SectionFour = () => {
  return (
    <div className="container mx-auto py-6">
        <h1 className="text-4xl text-left font-semibold max-sm:text-2xl max-sm:text-center">Built for the way you work</h1>

        <div className="my-4">
            <nav class="py-4">
                    <ul class="flex justify-between max-sm:text-sm max-sm:grid max-sm:grid-cols-2 max-sm:gap-y-3">
        ...
        <div className="grid grid-cols-6 gap-3 items-center max-sm:flex max-sm:p-2">
