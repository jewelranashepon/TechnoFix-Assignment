...
const SectionFive = () => {
  return (
    <div className="container py-6 mx-auto max-sm:py-0">
        <h1 className="text-3xl font-semibold text-left max-sm:text-2xl max-sm:text-center">Built for all kinds of teams</h1>

        <div className="my-4 max-sm:my-1">
            <nav class="py-4">
                    <ul class="flex justify-start gap-4 max-sm:text-sm max-sm:grid max-sm:grid-cols-2 max-sm:gap-y-3">
        ...
        <div className="grid grid-cols-6 my-4 gap-3 p-2 max-sm:my-0 max-sm:grid-cols-1">
